...
| 10f | Shipping & returns page — `templates/page.shipping.json`: `jci-size-guide-hero` reused, plus `jci-shipping-overview`, `jci-shipping-info`, `jci-shipping-policy` | done |
